...
## Теория
- Массивы символов и строки с завершающим `\0`.
- Копирование и конкатенация строк: `ft_strcpy`, `ft_strcat`.
- Проверка символов по классам: `is_alpha`, `is_numeric`.
- Преобразование регистра: `strupcase`, `strlowcase`.

## Навыки
- Понимание ключевых концепций темы C02.

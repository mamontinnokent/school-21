...
## Теория
- Использование указателей на функции: `int (*f)(int)`.
- Передача функций как параметров обобщённых алгоритмов.
- Построение `map` и `filter` для массивов чисел или строк.
- Работа с `void *` для хранения произвольных типов данных.

## Навыки
- Понимание ключевых концепций темы C11.

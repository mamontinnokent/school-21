...
## Теория
- Форматированный вывод целых: `ft_putnbr` через деление и модуль.
- Парсинг числа из строки: проверка пробелов и знака в `ft_atoi`.
- Работа с различными базами: `ft_putnbr_base`, `ft_atoi_base`.
- Валидация входных данных перед конвертацией.

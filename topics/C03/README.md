...
## Теория
- Лексикографическое сравнение строк: `ft_strcmp`, `ft_strncmp`.
- Поиск подстрок: `strstr` и вариации.
- Ограниченная конкатенация с контролем длины.
- Возврат указателей внутри строк без копирования.

## Навыки
- Понимание ключевых концепций темы C03.

...
## Теория
- Адресация памяти через указатели: `int *ptr = &value;`.
- Изменение значений по указателю: `*ptr = 42;`.
- Передача массивов и строк в функции.
- Работа с указателями на указатели для управления таблицами.

## Навыки
- Понимание ключевых концепций темы C01.

...
## Теория
- Создание статической библиотеки: `ar rcs libft.a *.o`.
- Разделение кода на заголовки `.h` и исходники `.c`.
- Написание Makefile с целями `all`, `clean`, `fclean`, `re`.
- Инкапсуляция функционала в переиспользуемые модули.

## Навыки
- Понимание ключевых концепций темы C09.

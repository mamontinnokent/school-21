...
## Теория
- Перенаправление потоков: `grep foo < input.txt > result.log`.
- Связка команд через конвейеры: `cat file | sort | uniq`.
- Работа с переменными окружения: `export PATH="..."`.
- Комбинирование условий выполнения: `make && ./a.out`.

## Навыки
- Понимание ключевых концепций темы Shell01.

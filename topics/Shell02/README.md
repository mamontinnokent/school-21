...
## Теория
- Поиск файлов с критериями: `find . -name "*.c"`.
- Фильтрация текста регулярными выражениями: `grep -E "^[0-9]+$" data`.
- Архивация и распаковка: `tar -czf backup.tgz src/`.
- Контроль процессов: `ps aux` и `kill -9 PID`.

## Навыки
- Понимание ключевых концепций темы Shell02.

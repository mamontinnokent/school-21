...
## Теория
- Выделение памяти `malloc` и освобождение `free`.
- Создание копий строк через `ft_strdup`.
- Формирование динамических диапазонов чисел в массивах.
- Обработка ошибок выделения и возврат значений через указатель.

## Навыки
- Понимание ключевых концепций темы C07.

...
## Теория
- Определение узла односвязного списка с указателем `next`.
- Добавление элементов в начало и конец списка.
- Итерация и поиск по списку с помощью временных указателей.
- Удаление и освобождение списка без утечек памяти.

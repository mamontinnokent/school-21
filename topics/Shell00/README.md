...
## Теория
- Навигация по дереву каталогов: `pwd`, `ls`, `cd ..`.
- Создание объектов: `touch file.txt`, `mkdir project`.
- Настройка прав доступа: `chmod 755 script.sh`, просмотр `ls -l`.

## Навыки
- Понимание ключевых концепций темы Shell00.
